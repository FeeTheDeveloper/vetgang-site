        ...
        <Container>
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="text-display-lg font-semibold text-white sm:text-display-xl">
              Selective membership for veteran operators ready to execute.
            </h1>
            <p className="text-body-lg text-white/85">
              Vet Gang membership is verification-driven and mission-aligned. We prioritize veteran-owned businesses and
              leaders committed to disciplined standards, trusted collaboration, and long-term growth.
            </p>
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <div className="space-y-5">
              ...
              <h2 className="text-headline-xl font-semibold text-white">Submit your profile with clarity.</h2>
              <p className="text-body-md text-white/75">
                Share your leadership role, business details, and operational focus. Every submission is reviewed before
